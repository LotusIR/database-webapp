            ...
            <el-container>
                <el-aside width="200px">
                    <el-menu style="border-right: 0px">
                        <el-menu-item index="1-1" @click="studentInfo">个人信息</el-menu-item>
                        <el-menu-item index="1-2" @click="selectCourse">选课退课</el-menu-item>
                        <el-menu-item index="1-3" @click="courseHistroy">已修课程</el-menu-item>
                    </el-menu>
                </el-aside>
                <el-main>
                    <router-view />
...
<script>
    export default {
        ...
        methods: {
            selectCourse() {
                this.$router.push("/selectCourses")
            },
            studentInfo() {
                this.$router.push("/studentInfo")
            },
            courseHistroy() {
                this.$router.push("/courseHistory")
            },
